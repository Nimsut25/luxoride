...
<section class="user_profile inner_pages">
  <div class="container">
    ...
    <input type="hidden" name="fullname" value="<?php echo htmlentities($result->FullName); ?>">
    <input type="hidden" name="emailid" value="<?php echo htmlentities($result->EmailId); ?>">
    <input type="hidden" name="mobilenumber" value="<?php echo htmlentities($result->ContactNo); ?>">
    <input type="hidden" name="amount" value="<?php echo isset($_POST['amount']) ? htmlentities($_POST['amount']) : ''; ?>">
