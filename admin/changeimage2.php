<?php
    ...
    if (strlen($_SESSION['alogin']) == 0) {
        ...
        if (isset($_POST['update'])) {
            ...
            move_uploaded_file($_FILES["img2"]["tmp_name"], "../assets/images/carimages/" . $_FILES["img2"]["name"]);
...
<div class="col-sm-8">
<img src="../assets/images/carimages/<?php echo htmlentities($result->Vimage2); ?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }
    }?>
</div>
