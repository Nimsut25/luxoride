...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2 id="animated-header">Find the Best <span>CarForYou</span></h2>
      <script src="../animation/script.js"></script>
      <p>"Looking for the perfect car for your next trip? Our wide selection ensures you'll find the ideal vehicle to suit your needs. Whether it's a compact city ride or a spacious family SUV, we have you covered. Start your journey today and discover the best car for you!"</div>
    <div class="row">
...
<div class="car-info-box"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>"><img src="assets/images/carimages/<?php echo htmlentities($result->Vimage1); ?>" class="img-responsive" alt="image"></a>
<ul>
